...
class flesh_lab(BaseGameplayScene):
    def __init__(self, game, player, hud, dungeon_data=None, is_dark=False):
        ...
        if dungeon_data is None:
            dungeon_data_path = os.path.abspath(resource_path(os.path.join("data", "dungeons", "flesh_lab.json")))
            try:
        ...
        quest_tracker.update_quest_progress("Descend", "the Flesh Algorithm lab")
