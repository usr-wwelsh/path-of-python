...
def display_dungeon(dungeon_data, canvas, offset_x, offset_y, zoom_scale):
    ...
    # Convert the Pygame surface to a Tkinter-compatible image
    pil_image = Image.frombytes("RGBA", (scaled_width, scaled_height), pygame.image.tostring(scaled_surface, "RGBA", False))
