...
class Enemy(pygame.sprite.Sprite):
    ...
    def draw(self, screen, camera_x, camera_y, zoom_level):
        ...
        if self._scaled_image_cache is None or zoom_level != self._last_zoom_level or scale_factor != self._last_scale_factor:
            self._scaled_image_cache = pygame.transform.scale(self.image, (int(self.rect.width * zoom_level * scale_factor), int(self.rect.height * zoom_level * scale_factor)))
            self._last_zoom_level = zoom_level
            self._last_scale_factor = scale_factor
        scaled_image = self._scaled_image_cache
